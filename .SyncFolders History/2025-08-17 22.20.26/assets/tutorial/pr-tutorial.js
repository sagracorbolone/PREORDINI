  ...
  const slides = [
    {
      ...
      text: "ISTRUZIONI COMPILAZIONE PRE ORDINE : Questa app NON sostituisce l'ordine ma ti consente di compilare il preordine comodamente dal tuo smartphone evitando di compilare manualmente il classico foglietto cartaceo con la copia del menù. Ti permetterà di ridurre il tempo di permanenza presso le casse ed annullerà il rischio di commettere errori di copiatura da parte dei cassieri"},
    { img: "/assets/tutorial/img2.JPG", text: "Compila i campi NOME , NUMERO TAVOLO e NUMERO COMMENSALI" },
    { img: "/assets/tutorial/img3.JPG", text: "Seleziona la categoria (es BEVANDE, CONTORNI E VARIE , ecc) premendo “+” o "-" per aprire o chiudere il menù a tendina di categoria. Poi premi “+” o “-” accanto alle pietanze per incrementarle o ridurle di 1 unità. Procedere fino a completamento dell’ordine" },
