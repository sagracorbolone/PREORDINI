  ...
  const slides = [
    {
      ...
      text: `APP PREORDINE: Questa app NON sostituisce l'ordine ma ti consente di compilare il pre ordine comodamente dal tuo smartphone evitando l'utilizzo del classico foglietto cartaceo del menù" },
